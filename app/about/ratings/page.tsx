    ...
    <ArticlePage>
      <article className="prose prose-neutral max-w-none prose-a:no-underline prose-a:text-(--blue) prose-headings:text-[#3a3a3a] prose-strong:text-[#3a3a3a]">
        ...
        <p>
          ...
          used. Note that I am grouping RBs, WRs, and TEs into one group, since every player at
          one of those positions can play each of the other two positions.
        </p>
        <p>
          If you want to learn more about attributes and how they affect player performance, I
          highly recommend{" "}
          <a href="http://www.gamefaqs.com/nes/587686-tecmo-super-bowl/faqs/44195" className="font-bold">
            this guide
          </a>
          .
        </p>
        ...
        <p>
          ...
          scores 100% on that attribute. The highest Pass Control is 81, shared by both Montana
          and QB Bills, who again both get 100%. Since QB Eagles has Pass Control of 69, he
        ...
        <p>
          Once each attribute score is calculated, they are averaged to give a final score.
          However, rather than treating all scores as equal, I weight each score based on its
          importance for determining the performance of the player at that position.
        </p>
        <p>
        ...
        <p>
          Rice: <strong>89.58%</strong> ((10 * (69.84 / 100)) + (30 * (92 / 100)) + (5 * (0 /
          100)) + (5 * (100 / 100)) + (50 * (100 / 100)))
        </p>
